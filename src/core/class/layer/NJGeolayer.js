...
const layerclass = BaseTileLayer.createSubclass({
    ...
    getTileUrl: function(level, row, col) {
        ...
        var templateUrl = this.url + '?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0' + 
        '&LAYER=' + this.layerid + '&STYLE=' + this.styleid + '&TILEMATRIXSET=' + 
        this.tileMatrixSet + '&TILEMATRIX=' + level + '&TILEROW=' + row + '&TILECOL=' + col + '&FORMAT=' + this.format;
        return templateUrl;
    },
