...
export default {
    ...
    data() {
        return {
            ...
            barData:{
                    dimensions: ['product', '公共管理与公共服务设施用地', 
                    '商业服务业设施用地', '非建设用地', '绿地与广场用地',
                    '建设用地', '工业用地', '居住用地',
                    '道路与交通设施用地', '公用设施用地', '物流仓储用地'],
                    source: [{product:'所选累计',公共管理与公共服务设施用地:0,
                    商业服务业设施用地:0,非建设用地:0,绿地与广场用地:0,
                    建设用地:0,工业用地:0,居住用地:0,
                    道路与交通设施用地:0,公用设施用地:0,物流仓储用地:0}]
            },
            result:{},
            pieVis:false,
            legendData:[],
    ...
    methods: {
        ...
        areaSwitch(item) {
            ...
            console.log(this.currentAreasArr)
            this.echartsData();
        ...
        echartsData(){
            ...
            let res = this.result[this.currentAreasArr];
            for(let k=0;k<10;k++){
                 
                this.pieData[k].value = res.find(e=>{return e.用地名称 == this.barData.dimensions[k+1]}).面积M2
            }
        ...
        initBarcharts(){
            ...
            //初始化要展示的数据
            var a = [];
            self.barData.source = [{product:'所选累计',公共管理与公共服务设施用地:0,
                    商业服务业设施用地:0,非建设用地:0,绿地与广场用地:0,
                    建设用地:0,工业用地:0,居住用地:0,
                    道路与交通设施用地:0,公用设施用地:0,物流仓储用地:0}];
            if(self.currentAreasArr=='全市'){
                ...
                a = self.currentAreasArr[0];
            }
            self.barData.source[0].公共管理与公共服务设施用地 += res[a][2].面积HA;
            self.barData.source[0].商业服务业设施用地 += res[a][3].面积HA;
            self.barData.source[0].非建设用地   += res[a][4].面积HA;
            self.barData.source[0].绿地与广场用地 += res[a][5].面积HA;
            self.barData.source[0].建设用地 += res[a][6].面积HA;
            self.barData.source[0].工业用地 += res[a][7].面积HA;
            self.barData.source[0].居住用地   += res[a][8].面积HA;
            self.barData.source[0].道路与交通设施用地 += res[a][9].面积HA;
            self.barData.source[0].公用设施用地 += res[a][10].面积HA;
            self.barData.source[0].物流仓储用地 += res[a][11].面积HA;


            self.barData.source[0].公共管理与公共服务设施用地 = (self.barData.source[0].公共管理与公共服务设施用地).toFixed(4);
            self.barData.source[0].商业服务业设施用地 = (self.barData.source[0].商业服务业设施用地).toFixed(4);
            self.barData.source[0].非建设用地  = (self.barData.source[0].非建设用地).toFixed(4);
            self.barData.source[0].绿地与广场用地 = (self.barData.source[0].绿地与广场用地).toFixed(4);
            self.barData.source[0].建设用地 = (self.barData.source[0].建设用地).toFixed(4);
            self.barData.source[0].工业用地 = (self.barData.source[0].工业用地).toFixed(4);
            self.barData.source[0].居住用地   = (self.barData.source[0].居住用地).toFixed(4);
            self.barData.source[0].道路与交通设施用地 = (self.barData.source[0].道路与交通设施用地).toFixed(4);
            self.barData.source[0].公用设施用地 = (self.barData.source[0].公用设施用地).toFixed(4);
            self.barData.source[0].物流仓储用地 = (self.barData.source[0].物流仓储用地).toFixed(4);
